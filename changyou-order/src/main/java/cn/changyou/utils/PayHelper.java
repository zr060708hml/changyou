...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId, String title, String money) {
        String key = "cy.pay.wx.url." + orderId;
        try {
        ...
        try {
            ...
            //回调地址，付款成功后的接口
            data.put("notify_url", "http://test.changyou.com/wxpay/notify");
            // 交易类型为扫码支付
